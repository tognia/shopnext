...
const Navbar = () => {
  return (
    <div className='w-full bg-blue text-white'>
      ...
      <div className='max-w-Container mx-auto h-20 px-4 flex items-center gap-2'>
        ...
        <div className='h-10 flex flex-1 relative'>
          <input className='h-full w-full rounded-full px-4 text-black text-base outline-none
          border-[1px] border-transparent focus-visible:border-black duration-200' type='text'
    ...
    gap-2 h-12 px-15 rounded-full hover:bg-hoverBg duration-300 relative'>
        ...
        <span className='absolute w-4 h-4 bg-yellow text-black top-0 right-4 rounded-full
